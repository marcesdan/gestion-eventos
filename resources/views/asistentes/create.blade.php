...
<form method="POST" action="{{ url('asistentes') }}" class="form">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-7">
            <input type="email" name="email" id="email" class="form-control" placeholder="email@ejemplo.com" value="{{ old('email') }}">
        </div>
    </div>
    <div class="form-group row">
        <label for="telefono" class="col-lg-3 col-form-label form-control-label field-label-responsive lead">Teléfono</label>
        <div class="col-lg-7">
            <input type="number" name="telefono" id="telefono" class="form-control" placeholder="telefono" value="{{ old('telefono') }}">
        </div>
    </div>
